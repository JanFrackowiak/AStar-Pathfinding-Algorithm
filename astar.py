...
def algorithm(draw, grid, start, end):
    ...
    came_from = {}
    g_value = {cube: float("inf") for row in grid for cube in row}
    g_value[start] = 0
    f_value = {cube: float("inf") for row in grid for cube in row}
    f_value[start] = heuristic(start.get_pos(), end.get_pos())
    ...
    while not open_set.empty():
        ...
        for neighbor in current.neighbors:
            ...
            if temp_g_value < g_value[neighbor]:
                ...
                f_value[neighbor] = temp_g_value + heuristic(neighbor.get_pos(), end.get_pos())
